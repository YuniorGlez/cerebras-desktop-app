...
class StaticAuthProvider {
    ...
    get clientMetadata() { return { client_name: 'Cerebras Desktop (Static)', redirect_uris: [this.redirectUrl] }; }
...
async function connectMcpServerProcess(serverId, connectionDetails, authProviderInstance = null) {
    ...
    const client = new Client({ name: "cerebras-desktop", version: appInstance.getVersion(), capabilities: { tools: true } });
    let transport;
